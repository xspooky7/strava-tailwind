...
export function RowActions({ row, onUnstar }: { row: any; onUnstar: (id: number) => void }) {
  return (
    <AlertDialog>
      <DropdownMenu>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={() => onUnstar(row.original.segment_id)}>Continue</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  )
